...
class camera {
  public:
	  ...
	  double vert_fov = 90;					// Vertical field of view / viewing angle
  ...
  private:
	  ...
	  ray get_ray(int i, int j) const {
		  // Get a random sampled camera ray for the pixel at location i,j, originating from 
	  ...
	  vec3 pixel_sample_square() const {
		  // Retuirns a random point in the square surrounding a pixel at the origin.
